...
public:
	...
	virtual void cursorCallback(GLFWwindow * window, double in_deltaX, double in_deltaY) = 0;
};
...
private:
	...
	static void cursor_callback(GLFWwindow * window, double in_deltaX, double in_deltaY);
};
